    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.DecimalField(null=True, blank=True, max_digits=8, decimal_places=2)),
                ...
                ('price', djmoney.models.fields.MoneyField(default=None, decimal_places=2, null=True, blank=True, default_currency='USD', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(to='geography.Location', null=True, blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='store',
            field=models.ForeignKey(to='purchase.Store', null=True, blank=True),
        ),
        migrations.AddField(
            model_name='purchaseevent',
            name='unit',
            field=models.ForeignKey(to='core.Unit', null=True, blank=True),
        ),
        migrations.AddField(
            model_name='purchaseevent',
            name='user',
